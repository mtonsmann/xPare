...
- Docs follow-up: added the GitHub Actions download flow to `docs/release-model.md`
  and linked that release model from `README.md` as the place to find main dev
  preview artifact instructions.
